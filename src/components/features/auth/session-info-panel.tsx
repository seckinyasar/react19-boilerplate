...
export function SessionInfoPanel({
  ...
  return (
    <aside aria-label="Current session" className="flex w-[400px] flex-col border border-border rounded-[20px] p-10">
      ...
      <dl className="flex flex-col gap-4 text-base">
        <div>
          ...
          <dd>{session.expiresAt != null ? formatExpiresAt(session.expiresAt) : '—'}</dd>
        </div>
      </dl>
