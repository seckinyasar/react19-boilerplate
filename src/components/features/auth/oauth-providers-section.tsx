...
import { signInWithDiscord, signInWithGithub, signInWithGoogle } from '@/lib/better-auth/actions'
...
export function OAuthProvidersSection() {
  ...
  return (
    <div className="flex flex-col w-full items-center gap-8">
      <div className="flex w-full items-center justify-center" role="presentation">
        <span className="w-full h-px bg-border" />
        <span className="text-muted-foreground text-base px-3 shrink-0">OR</span>
        <span className="w-full h-px bg-border" />
      </div>
